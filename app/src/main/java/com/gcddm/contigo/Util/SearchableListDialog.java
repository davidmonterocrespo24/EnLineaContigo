...
/**
 * Created by GRID-3 on 25/05/2017.
 */
...
public class SearchableListDialog extends DialogFragment implements
    ...
    private String _strPositiveButtonText="Aceptar";
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.lista_bucar_spinner, null);
        setData(rootView);
        ...
        String strTitle = _strTitle == null ? "Seleccionar" : _strTitle;
